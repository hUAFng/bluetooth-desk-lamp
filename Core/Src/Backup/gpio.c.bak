...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, BT_EN_Pin|RGB_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : BT_EN_Pin ASR_Res_Pin RGB_Pin */
  GPIO_InitStruct.Pin = BT_EN_Pin|ASR_Res_Pin|RGB_Pin;
